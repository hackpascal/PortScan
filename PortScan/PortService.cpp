...
{2640, "sai-sentlm", "Sabbagh Associates Licence Manager"},
...
{3283, "Apple Remote Desktop (Net Assistant)", "Net Assistant"},
{3284, "4talk", "4Talk"},
{3285, "plato", "Plato"},
{3286, "e-net", "E-Net"},
...
{3478, "stun-behavior", "STUN Behavior Discovery over TCP"},
{3478, "turn", "TURN over TCP"},
...
{3679, "Escale (Newton Dock)", "Newton Dock"},
...
{4360, "matrix_vnet", "Matrix VNet Communication Protocol"},
...
{4901, "flr_agent", "FileLocator Remote Search Agent"},
...
{5349, "stun-behaviors", "STUN Behavior Discovery over TLS"},
{5349, "stuns", "STUN over TLS"},
{5349, "turns", "TURN over TLS"},
...
{6568, "canit_store", "CanIt Storage Manager"},
...
{6716, "printercare-cc", "PrinterCare cloud service"},
...
{9616, "erunbook_agent", "eRunbook Agent"},
{9616, "erunbook-agent", "eRunbook Agent"},
{9617, "erunbook_server", "eRunbook Server"},
...
{31620, "lm-mon", "lm mon"},
{31685, "dsx_monitor", "DS Expert Monitor"},
...
{44123, "z-wave-s", "Z-Wave Secure Tunnel"},
...
{45000, "asmp", "NSi AutoStore Status Monitoring Protocol data transfer"},
{45001, "asmps", "NSi AutoStore Status Monitoring Protocol secure data transfer"},
...
const int g_nNumOfServices = sizeof (g_pPortServices) / sizeof (g_pPortServices[0]);

const char *GetPortService(WORD wPort)
{
	for (int i = 0; i < sizeof (g_pPortServices) / sizeof (g_pPortServices[0]); i++)
	{
		if (g_pPortServices[i].wPort == wPort)
		{
			if (g_pPortServices[i].description)
				return g_pPortServices[i].description;

			return g_pPortServices[i].name;
		}
	}
